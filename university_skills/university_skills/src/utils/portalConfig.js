import { Award, Briefcase, FolderKanban, GraduationCap, LayoutDashboard, MessageSquare, Shield, Trophy, UserCircle, Compass, FileText } from 'lucide-react'
...
export const adminNav = [
  ...
  { to: '/admin/students', label: 'Talent Discovery', icon: UserCircle },
