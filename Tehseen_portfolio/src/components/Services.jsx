  ...
  const services = [
    {
      ...
      icon: <FiMonitor size={40} className="text-[#00f0ff]" />
    },
    {
      title: "AI Projects",
    ...
    },
    {
      ...
      icon: <FiSmartphone size={40} className="text-[#3DDC84]" />
    },
    {
      ...
      icon: <SiFlutter size={40} className="text-[#02569B]" />
    },
    {
      ...
      icon: <FiZap size={40} className="text-[#FFCA28]" />
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="glass-card p-8 rounded-2xl text-center group hover:-translate-y-3 transition-all duration-300 border border-white/5 hover:border-[#00f0ff]/50 hover:shadow-[0_0_25px_rgba(0,240,255,0.2)]"
            >
              <div className="mx-auto w-20 h-20 bg-white/5 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                {service.icon}
              </div>
